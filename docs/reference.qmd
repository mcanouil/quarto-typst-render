...
[Math](examples/math.qmd) shows the `math: typst` takeover, and [Output and files](examples/output-and-files.qmd) shows `preamble`, `input`, `output-directory`, and the cache at work.
