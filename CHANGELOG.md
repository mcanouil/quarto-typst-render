...
- docs: Expand the documentation site with one example page for each topic: maths, figures and tables, cross-references, brand colours, data from R and Python, output and files, and presentations.
